...
export default function Home({ exploreData, cardsData }) {
  return (
    <div className="">
      ...
      <div className="h-screen overflow-y-scroll scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-transparent scrollbar-track scrollbar-thumb-rounded-full">
